export class BytedanceWebSocket implements TinyWebSocket {

	protected ws: tt.SocketTask;
	...
	constructor(url: string, protocols?: string | string[]) {
		...
		this.ws.onOpen((ev) => {
			console.log('tt.onOpen', url, typeof this.onopen);
			this.onopen && this.onopen();
		});
		this.ws.onClose((ev) => {
			console.log('tt.onClose', url, typeof this.onclose);
			this.onclose && this.onclose(ev);
		});
		this.ws.onError((ev) => {
			console.error('tt.onError', url, typeof this.onerror);
